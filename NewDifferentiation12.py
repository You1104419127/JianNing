...
# In this 1 m by 1 m square plane, each point is separated by 1 unit of 1 cm, we have 10^4 points.
x_01 = -4    # x-coordinate of charge 1
x_02 = 6     # x-coordinate of charge 2
...
x_CM = 5   # x-coordinate of center of charges
...
for i in range(10**4):   # use FOR loop to find all distance
...
plt.scatter(dCM, potential, label = "potential due to 2 charges",s=0.01)
plt.xlabel("distance (1 centi-meters)")
